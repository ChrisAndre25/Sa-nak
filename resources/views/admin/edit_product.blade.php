...
<div class="d-flex justify-content-center align-items-center">
    <div class="card p-3" style="width: 50rem;">
        ...
        <form action="{{ action('SellerController@updateProduct', $product->id) }}" method="post">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="rent_price" name="rent_price" value="{{ $product->rent_price }}">
            </div>
            <div class="form-group">
